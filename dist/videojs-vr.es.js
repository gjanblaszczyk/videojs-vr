/*! @name videojs-vr @version 1.6.1 @license Apache-2.0 */
...
import { createFOARenderer } from 'omnitone';
...
function (_videojs$EventTarget) {
   ...
   */
  function OmnitoneController(audioContext, video, options) {
    var _this;
    ...
    _this.foaRenderer = createFOARenderer(audioContext, settings);
...
function (_Plugin) {
  ...
  _proto.requestAnimationFrame = function requestAnimationFrame(fn) {
    console.log('call requestAnimationFrame', this.vrDisplay);
